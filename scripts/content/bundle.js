...
/* harmony export (immutable) */ __webpack_exports__["printDateTime"] = printDateTime;
/* harmony export (immutable) */ __webpack_exports__["trimUrl"] = trimUrl;
/* harmony export (immutable) */ __webpack_exports__["getNearestLimitWithValue"] = getNearestLimitWithValue;
/* harmony export (immutable) */ __webpack_exports__["imageToBase64"] = imageToBase64;
/* harmony export (immutable) */ __webpack_exports__["getHtmlTemplate"] = getHtmlTemplate;
/* harmony export (immutable) */ __webpack_exports__["getResource"] = getResource;
/* harmony export (immutable) */ __webpack_exports__["trimUrlToHostname"] = trimUrlToHostname;
/* harmony export (immutable) */ __webpack_exports__["trimUrlToPath"] = trimUrlToPath;
/* harmony export (immutable) */ __webpack_exports__["trimUrlGetParams"] = trimUrlGetParams;
/* harmony export (immutable) */ __webpack_exports__["trimUrlHttpProtocol"] = trimUrlHttpProtocol;
/* harmony export (immutable) */ __webpack_exports__["currentTab"] = currentTab;
/* harmony export (immutable) */ __webpack_exports__["htmlStringToElement"] = htmlStringToElement;
/* harmony export (immutable) */ __webpack_exports__["wordsToReadingTimeInMinutes"] = wordsToReadingTimeInMinutes;
/* harmony export (immutable) */ __webpack_exports__["createSubmissionForm"] = createSubmissionForm;
/* harmony export (immutable) */ __webpack_exports__["find_headline_id"] = find_headline_id;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__models_limit__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_moment_min_moment_with_locales_min_js__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_moment_min_moment_with_locales_min_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__node_modules_moment_min_moment_with_locales_min_js__);
...
function printDateTime(dateString) {
    if (dateString === undefined || dateString === null || dateString.length === 0)
        return "";
    try {
        let then = __WEBPACK_IMPORTED_MODULE_1__node_modules_moment_min_moment_with_locales_min_js__(dateString);
        let now = __WEBPACK_IMPORTED_MODULE_1__node_modules_moment_min_moment_with_locales_min_js__();
        return `${__WEBPACK_IMPORTED_MODULE_1__node_modules_moment_min_moment_with_locales_min_js__["duration"](then.diff(now)).humanize(true)}`;
    }
    catch (e) {
        return "";
    }
 ...
 * @returns {null}
 */
function getNearestLimitWithValue(limits, reportCount) {
    let lessOrEqualLimitsInDescending = limits
        .filter((limit) => limit.value <= reportCount)
        .sort((a, b) => b.value - a.value);
    if (lessOrEqualLimitsInDescending.length > 0)
        return lessOrEqualLimitsInDescending[0];
    return { key: __WEBPACK_IMPORTED_MODULE_0__models_limit__["Limits"].Ignore, value: 0 };
}
/**
 ...
 * @returns {Promise<T>}
 */
function getHtmlTemplate(templatePath, templateSection = null) {
    return new Promise((resolve, reject) => fetch(chrome.extension.getURL(`html/templates/${templatePath}`))
        ...
        response.text()
            ...
            resolve(htmlDoc.querySelector(templateSection));
        });
    }));
}
/**
 ...
 * @returns {string}
 */
function trimUrlToHostname(url) {
    try {
 ...
 * @returns {string}
 */
function trimUrlHttpProtocol(url) {
    try {
        return url
            .replace("https", "")
            .replace("http", "")
 ...
 */
function wordsToReadingTimeInMinutes(words) {
 ...
 * @returns {Promise<any>}
 */
function createSubmissionForm(submission, textareaName, formTitle) {
    return new Promise((resolve, reject) => getHtmlTemplate("submissionForm.html", "body")
        .then((template) => {
        let html = template.cloneNode(true);
        let textarea = html.querySelector('textarea');
        textarea.setAttribute("name", textareaName);
        let title = html.querySelector("#news-enhancer-submission-form-title");
...
function find_headline_id(headlineUrl, urlTemplates) {
...
const CLASS_PREFIX = "news-enhancer";
/* harmony export (immutable) */ __webpack_exports__["CLASS_PREFIX"] = CLASS_PREFIX;

let templates = {
    article: "article.html",
    headline: "headlineInfo.html",
    submissionForm: "submissionForm.html",
...
/* harmony export (immutable) */ __webpack_exports__["HTML_FILES"] = HTML_FILES;
...
/* harmony export (immutable) */ __webpack_exports__["RESOURCES"] = RESOURCES;
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (immutable) */ __webpack_exports__["createMessage"] = createMessage;
const messageTypes = {
...
/* harmony export (immutable) */ __webpack_exports__["messageTypes"] = messageTypes;
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__util_debug__ = __webpack_require__(3);

class Api {
    constructor() {
        this._prod = "http://165.227.136.59/";
        this._dev = "http://localhost:8000/";
        this.BaseUrl = this._prod;
        this._apiBase = `${this.BaseUrl}api/`;
    }
    /**
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__journalist__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__util_util__ = __webpack_require__(0);


class Revision {
    constructor() {
        this.printJournalists = () => {
            let journalists = "";
    ...
    get timestamp() {
        return Object(__WEBPACK_IMPORTED_MODULE_1__util_util__["printDateTime"])(this._timestamp);
    }
    fromJSON(revision) {
        this.id = revision.id;
        ...
        for (let j of revision.journalists) {
            let journalist = new __WEBPACK_IMPORTED_MODULE_0__journalist__["default"]();
...
/* harmony default export */ __webpack_exports__["default"] = (Journalist);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (immutable) */ __webpack_exports__["createSummarySubmission"] = createSummarySubmission;
/* harmony export (immutable) */ __webpack_exports__["createReportSubmission"] = createReportSubmission;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__util_api__ = __webpack_require__(4);

function createSummarySubmission(id) {
    let notification = {
    ...
    return {
        ...
        url: __WEBPACK_IMPORTED_MODULE_0__util_api__["default"].endpoints.SUBMIT_SUMMARY,
        notification: notification,
        payload: { headline: id }
    };
}
function createReportSubmission(category, id) {
    let notification = {
    ...
    return {
        formId: "news-enhancer-headline-submission-form",
        url: __WEBPACK_IMPORTED_MODULE_0__util_api__["default"].endpoints.REPORT,
        notification: notification,
...
(function (ArticleCategory) {
    ...
    ArticleCategory["Feed"] = "FEED";
    ArticleCategory["External"] = "EXTERNAL";
    ArticleCategory["Video"] = "VIDEO";
    ArticleCategory["NoInfo"] = "NOINFO";
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__revision__ = __webpack_require__(7);
...
class HeadlineInfo {
    ...
    get updated() {
        return Object(__WEBPACK_IMPORTED_MODULE_0__util_util__["printDateTime"])(this._updated);
    }
    get published() {
        return Object(__WEBPACK_IMPORTED_MODULE_0__util_util__["printDateTime"])(this._published);
    }
    fromJSON(info) {
        this._updated = info.updated;
        this._published = info.published;
        this.category = info.category;
        this.revision = new __WEBPACK_IMPORTED_MODULE_1__revision__["default"]();
        this.revision.fromJSON(info.revision);
    }
}
/* harmony default export */ __webpack_exports__["default"] = (HeadlineInfo);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ReportCategory", function() { return ReportCategory; });
var ReportCategory;
(function (ReportCategory) {
    ReportCategory["Clickbait"] = "Clickbait";
    ReportCategory["FakeNews"] = "Fake news";
...
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__util_util__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__util_debug__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__config_constants__ = __webpack_require__(1);
...
class BaseOverlay {
    constructor(rootElm = "") {
        ...
        this._element = null;
        this._rootElementName = `${__WEBPACK_IMPORTED_MODULE_2__config_constants__["CLASS_PREFIX"]}${rootElm}`;
     ...
     */
    init() {
        Object(__WEBPACK_IMPORTED_MODULE_0__util_util__["getHtmlTemplate"])(this._templateName, this._templateClass)
            .then((html) => {
    ...
    setBaseElement(html) {
        ...
        __WEBPACK_IMPORTED_MODULE_1__util_debug__["default"].info("I will log that the child node should have been created and that the information will follow:");
...
/* harmony default export */ __webpack_exports__["default"] = (BaseOverlay);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__config_messageTypes__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__util_util__ = __webpack_require__(0);
...
class Modal {
    ...
    setSubmissionCallback(submission) {
        if (typeof submission === "undefined" || submission === null)
            return;
        let form = this._modal.querySelector(`#${submission.formId}`);
        let quit = form.querySelector("#news-enhancer-submission-quit-button");
        if (quit != null)
            ...
            for (let element of f.childNodes) {
                ...
                if (typeof elm.tagName !== "undefined" && (elm.tagName.toLowerCase() === "input" || elm.tagName.toLowerCase() === "textarea")) {
                    ...
                    if (name !== null && name.length !== 0)
                        newSubmission.payload[name] = elm.value;
                }
            }
            chrome.runtime.sendMessage(Object(__WEBPACK_IMPORTED_MODULE_0__config_messageTypes__["createMessage"])(__WEBPACK_IMPORTED_MODULE_0__config_messageTypes__["messageTypes"].SUBMIT, newSubmission));
            this.close();
        });
    }
    clear() {
    ...
    createElements() {
        Object(__WEBPACK_IMPORTED_MODULE_1__util_util__["getHtmlTemplate"])(this._templateName)
            .then((html) => {
            this._loading = html.querySelector(`.${this._classPrefix}-loading`);
            this._close = html.querySelector(`.${this._classPrefix}-close`);
            this._overlay = html.querySelector(`.${this._classPrefix}-overlay`);
            this._modal = html.querySelector(`.${this._classPrefix}`);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__baseOverlay__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__config_constants__ = __webpack_require__(1);


class BaseModeOverlay extends __WEBPACK_IMPORTED_MODULE_0__baseOverlay__["default"] {
    constructor(rootElm = "") {
        super(`-article-mode${rootElm}`);
        this._templateName = __WEBPACK_IMPORTED_MODULE_1__config_constants__["HTML_FILES"].templates.article;
        this._site = null;
        this._article = null;
    }
    quit_button_click() {
    ...
    onTemplateLoaded(html) {
        ...
        this._quit_mode_button = html.querySelector(`#${this._rootElementName}-quit`);
...
/* harmony default export */ __webpack_exports__["default"] = (BaseModeOverlay);
...
class BaseInjector {
    constructor(rootElm = "") {
        ...
        this._sites = [];
        this._templateName = "";
        this._rootElementName = `${__WEBPACK_IMPORTED_MODULE_1__config_constants__["CLASS_PREFIX"]}${rootElm}`;
        this._templateClass = `.${this._rootElementName}`;
    }
    init(data) {
        this._overlay.init();
    ...
    setValuesFromData(data) {
        ...
        if (typeof data.limits !== "undefined")
            this._limits = data.limits.map((item, index) => item.data).sort((a, b) => a.value - b.value);
    }
    clear() { }
    inject() {
        this.clear();
...
/* harmony default export */ __webpack_exports__["default"] = (BaseInjector);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__baseInjector__ = __webpack_require__(36);




class HeadlineInjector extends __WEBPACK_IMPORTED_MODULE_3__baseInjector__["default"] {
    constructor(overlay) {
        super("-headline");
        /**
         ...
         */
        this.createMarking = (node, id) => {
            let container = this._markTemplate.cloneNode(true);
            let icon = container.querySelector(`.${__WEBPACK_IMPORTED_MODULE_1__config_constants__["CLASS_PREFIX"]}-icon`);
            container.id = `${this._rootElementName}-${id}`;
            let markingClass = `${__WEBPACK_IMPORTED_MODULE_1__config_constants__["CLASS_PREFIX"]}-info`;
            let reportCount = this.getDataForNode(node).reports
                .map((elm) => elm.reports.length)
                .reduce((a, b) => a + b, 0);
            switch (Object(__WEBPACK_IMPORTED_MODULE_2__util_util__["getNearestLimitWithValue"])(this._limits, reportCount).key) {
                case __WEBPACK_IMPORTED_MODULE_0__models_limit__["Limits"].Ignore:
                    break;
                case __WEBPACK_IMPORTED_MODULE_0__models_limit__["Limits"].Low:
                    markingClass = `${__WEBPACK_IMPORTED_MODULE_1__config_constants__["CLASS_PREFIX"]}-low`;
                    break;
                case __WEBPACK_IMPORTED_MODULE_0__models_limit__["Limits"].Mid:
                    markingClass = `${__WEBPACK_IMPORTED_MODULE_1__config_constants__["CLASS_PREFIX"]}-mid`;
                    break;
                case __WEBPACK_IMPORTED_MODULE_0__models_limit__["Limits"].High:
                    markingClass = `${__WEBPACK_IMPORTED_MODULE_1__config_constants__["CLASS_PREFIX"]}-high`;
                    break;
            }
        ...
        this._templateName = __WEBPACK_IMPORTED_MODULE_1__config_constants__["HTML_FILES"].templates.headline;
    ...
    injectIntoNodes(nodes) {
        for (let node of nodes) {
            let elm = node;
            let data = this.getDataForNode(elm);
    ...
    getDataForNode(elm) { return null; }
}
/* harmony default export */ __webpack_exports__["default"] = (HeadlineInjector);
...
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__util_debug__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__baseInjector__ = __webpack_require__(36);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__util_util__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__overlay__ = __webpack_require__(43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__config_constants__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__config_messageTypes__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__modal__ = __webpack_require__(33);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__revision_mode__ = __webpack_require__(44);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__models_submission__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__report__ = __webpack_require__(45);
...
class ArticleInjector extends __WEBPACK_IMPORTED_MODULE_1__baseInjector__["default"] {
    constructor(infoOverlay) {
        super("-article");
        this.generateWordCloud = () => {
            __WEBPACK_IMPORTED_MODULE_6__modal__["default"]
                .getInstance()
                .startLoadingSequence();
            let messageData = { word_cloud_link: this._article.word_cloud };
            chrome.runtime.sendMessage(Object(__WEBPACK_IMPORTED_MODULE_5__config_messageTypes__["createMessage"])(__WEBPACK_IMPORTED_MODULE_5__config_messageTypes__["messageTypes"].WORDCLOUD_FOR_ARTICLE, messageData));
            this.closeMenu();
        };
        this.toggleMenu = () => {
        ...
        this._templateName = __WEBPACK_IMPORTED_MODULE_4__config_constants__["HTML_FILES"].templates.article;
        this._overlay = new __WEBPACK_IMPORTED_MODULE_3__overlay__["default"]();
        this._showMenu = true;
        this._menu = null;
        this._article = null;
        this._revision_mode = new __WEBPACK_IMPORTED_MODULE_7__revision_mode__["default"]();
        this._report_mode = new __WEBPACK_IMPORTED_MODULE_9__report__["default"]();
    ...
    showRelatedArticles() {
        __WEBPACK_IMPORTED_MODULE_6__modal__["default"]
            .getInstance()
            .startLoadingSequence();
        __WEBPACK_IMPORTED_MODULE_0__util_debug__["default"].info("We are all related...");
        this.closeMenu();
    }
    closeMenu() {
    ...
    submitSummary() {
        let submission = Object(__WEBPACK_IMPORTED_MODULE_8__models_submission__["createSummarySubmission"])(this._article.headline);
        Object(__WEBPACK_IMPORTED_MODULE_2__util_util__["createSubmissionForm"])(submission, "one_line", "Enter a one line summary for the headline")
            .then((data) => {
            let modal = __WEBPACK_IMPORTED_MODULE_6__modal__["default"].getInstance();
    ...
    onTemplateLoaded(html) {
        if (this._element !== null && typeof this._element !== "undefined")
            this._element.remove();
        this._element = html;
        let img = this._element.querySelector(`#${this._rootElementName}-icon`);
        img.src = Object(__WEBPACK_IMPORTED_MODULE_2__util_util__["getResource"])(__WEBPACK_IMPORTED_MODULE_4__config_constants__["RESOURCES"].icons.logo);
        img.onclick = this.onIconClick.bind(this);
        this._menu = this._element.querySelector(`.${this._rootElementName}-menu`);
        if (this._article.diffs.length === 0)
            this._menu.querySelector(`#${this._rootElementName}-revision-mode`).style.display = "none";
        this.closeMenu();
    ...
    inject() {
        super.inject();
        __WEBPACK_IMPORTED_MODULE_0__util_debug__["default"].info("ArticleInjector injecting");
...
/* harmony default export */ __webpack_exports__["default"] = (ArticleInjector);
...
class ArticleOverlay extends __WEBPACK_IMPORTED_MODULE_0__baseOverlay__["default"] {
    constructor() {
...
/* harmony default export */ __webpack_exports__["default"] = (ArticleOverlay);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__config_constants__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__baseMode__ = __webpack_require__(35);


class RevisionModeOverlay extends __WEBPACK_IMPORTED_MODULE_1__baseMode__["default"] {
    constructor() {
        super("-revision");
        this._templateName = __WEBPACK_IMPORTED_MODULE_0__config_constants__["HTML_FILES"].templates.article;
    ...
    navigateButton(button, other_button, increment_index, limit) {
    ...
    replace_content_with(newContent) {
        document.querySelector(this._site.articleTemplate.selector).outerHTML = newContent;
    }
    onTemplateLoaded(html) {
        super.onTemplateLoaded(html);
        this._next_diff_button = html.querySelector(`#${this._rootElementName}-navigation-forward`);
        this._progress = html.querySelector(`#${this._rootElementName}-navigation-progress`);
        this._previous_diff_button = html.querySelector(`#${this._rootElementName}-navigation-backward`);
    ...
    show() {
        ...
        if (this._actual_content === null) {
            this._actual_content = document.querySelector(this._site.articleTemplate.selector).cloneNode(true);
            this._next_diff_button.disabled = true;
        }
        this.replace_content_with(this._article.diffs[this._current_index]);
    }
}
/* harmony default export */ __webpack_exports__["default"] = (RevisionModeOverlay);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__baseMode__ = __webpack_require__(35);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__util_util__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__models_submission__ = __webpack_require__(9);
...
class ReportModeOverlay extends __WEBPACK_IMPORTED_MODULE_1__baseMode__["default"] {
    constructor() {
        super("-report");
        this._templateName = __WEBPACK_IMPORTED_MODULE_0__config_constants__["HTML_FILES"].templates.article;
        this._site = null;
    ...
    report_button_click(e) {
        ...
        let submission = Object(__WEBPACK_IMPORTED_MODULE_3__models_submission__["createReportSubmission"])(category, this._article.headline);
        Object(__WEBPACK_IMPORTED_MODULE_2__util_util__["createSubmissionForm"])(submission, "explanation", `Why report this article as a ${category.category}?`)
            .then((data) => {
            let modal = __WEBPACK_IMPORTED_MODULE_4__modal__["default"].getInstance();
            modal.setHtmlContent(data);
            modal.open();
        });
    }
    onTemplateLoaded(html) {
        let container = html.querySelector(`.${__WEBPACK_IMPORTED_MODULE_0__config_constants__["CLASS_PREFIX"]}-article-menu`);
...
/* harmony default export */ __webpack_exports__["default"] = (ReportModeOverlay);
...
class FindAttributeOnElementInHtmlTree {
    constructor(action, attribute = 'news-enhancer-headline-id') {
     ...
     */
    findAttr(node, steps, maxSteps, direction) {
        if (steps === maxSteps)
            return false;
        if (node === null || typeof node === "undefined" || node === null)
            return false;
        if (typeof node.hasAttribute === 'function' && node.hasAttribute(this.attribute)) {
            ...
            if (direction === "up") {
                return this.findAttr(node.parentNode, steps + 1, maxSteps, direction);
            }
            else {
                if (node.hasChildNodes()) {
                    for (let i = 0; i < node.children.length; i++) {
                        if (this.findAttr(node.children[i], steps + 1, maxSteps, direction)) {
                            return true;
                        }
                    }
                }
...
/* harmony default export */ __webpack_exports__["default"] = (FindAttributeOnElementInHtmlTree);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__injector__ = __webpack_require__(37);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__util_debug__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__util_util__ = __webpack_require__(0);



class FrontpageInjector extends __WEBPACK_IMPORTED_MODULE_0__injector__["default"] {
    constructor() {
        super(...arguments);
     ...
     * @param {number} id
     */
    injectHeadlineIdOnEachLink(htmlHeadline, id) {
    ...
    getDataForNode(elm) {
        ...
        if (site === null)
            return null;
        elm = elm.querySelector(site.headlineTemplate.url);
        ...
        if (typeof elm.href === "undefined" || elm.href.length === 0 || elm.href.indexOf("#") > 0)
            return null;
        let hostname = Object(__WEBPACK_IMPORTED_MODULE_2__util_util__["trimUrlToHostname"])(elm.href);
        let trimmedUrl = Object(__WEBPACK_IMPORTED_MODULE_2__util_util__["trimUrlToPath"])(elm.href);
        trimmedUrl = Object(__WEBPACK_IMPORTED_MODULE_2__util_util__["trimUrlGetParams"])(trimmedUrl);
        for (let site of this._sites) {
            let elmUrl = Object(__WEBPACK_IMPORTED_MODULE_2__util_util__["find_headline_id"])(elm.href, site.urlTemplates);
            for (let headline of site.headlines) {
                let headline_url = Object(__WEBPACK_IMPORTED_MODULE_2__util_util__["trimUrlToPath"])(headline.url);
                headline_url = Object(__WEBPACK_IMPORTED_MODULE_2__util_util__["trimUrlGetParams"])(headline_url);
    ...
    inject() {
        super.inject();
        this.injectOnHeadlineLists();
        __WEBPACK_IMPORTED_MODULE_1__util_debug__["default"].info("Front-pageInjector injecting");
    }
}
/* harmony default export */ __webpack_exports__["default"] = (FrontpageInjector);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__injector__ = __webpack_require__(37);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__util_debug__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__config_messageTypes__ = __webpack_require__(2);



class LinkInjector extends __WEBPACK_IMPORTED_MODULE_0__injector__["default"] {
    constructor(overlay) {
        super(overlay);
        this.findAllNodes = () => {
            return document.querySelectorAll("a");
        };
        this._linkToHeadlineMap = new Map();
    }
    inject() {
        super.inject();
        __WEBPACK_IMPORTED_MODULE_1__util_debug__["default"].info("LinkInjector injecting");
    }
    injectIntoNodes(nodes) {
        let messageData = [];
        for (let node of nodes) {
        ...
        let message = Object(__WEBPACK_IMPORTED_MODULE_2__config_messageTypes__["createMessage"])(__WEBPACK_IMPORTED_MODULE_2__config_messageTypes__["messageTypes"].FETCH_INFO_FOR_LINKS, messageData);
...
/* harmony default export */ __webpack_exports__["default"] = (LinkInjector);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__models_headline__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__config_constants__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__models_article__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__baseOverlay__ = __webpack_require__(32);
...
class HeadlineOverlay extends __WEBPACK_IMPORTED_MODULE_3__baseOverlay__["default"] {
    constructor() {
        super("-headline");
        this.setHeadlineDiffs = (template, headline) => {
            let diff = template.querySelector(`.${this._rootElementName}-overlay-revision-mode`);
            if (headline.diffs.length === 0) {
                diff.style.display = "none";
                return;
            }
            let class_prefix = `.${this._rootElementName}-overlay-revision-mode`;
            this._next_diff_button = template.querySelector(`${class_prefix}-navigation-forward`);
            this._progress = template.querySelector(`${class_prefix}-navigation-progress`);
            this._previous_diff_button = template.querySelector(`${class_prefix}-navigation-backward`);
            this._next_diff_button.onclick = this.forward_button_click.bind(this);
            this._previous_diff_button.onclick = this.backward_button_click.bind(this);
        ...
        this.setReports = (template, reports) => {
            for (let i = 0; i < reports.length; i++) {
                let currentReport = reports[i];
                let reportTemplate = this._reportTemplate.cloneNode(true);
                let titleNode = reportTemplate.querySelector(".news-enhancer-headline-report-title");
                titleNode.textContent = `${currentReport.category.category} reports`;
                let table = reportTemplate.querySelector(".news-enhancer-table-data");
                ...
                for (let j = 0; j < currentReport.reports.length; j++) {
                    ...
                    reportedTd.textContent = Object(__WEBPACK_IMPORTED_MODULE_4__util_util__["printDateTime"])(currentReport.reports[j].created);
        ...
        this.setContent = (content, title) => {
            let titleElement = this._element.querySelector(`.${this._rootElementName}-overlay-title`);
            titleElement.innerText = title;
            this._contentNode.innerHTML = "";
            this._contentNode.appendChild(content);
            this._contentNode.appendChild(this._closeButton);
        };
        this._info = new __WEBPACK_IMPORTED_MODULE_0__models_headline__["default"]();
    ...
    onTemplateLoaded(html) {
        ...
        this.setBaseElement(html.querySelector(class_prefix));
        this._articleTemplate = html.querySelector(`${class_prefix}-article-category-article`);
        this._noInfoTemplate = html.querySelector(`${class_prefix}article-category-noInfo`);
        this._feedTemplate = html.querySelector(`${class_prefix}-article-category-feed`);
        this._videoTemplate = html.querySelector(`${class_prefix}-article-category-video`);
        this._externalTemplate = html.querySelector(`${class_prefix}-article-category-external`);
        this._reportTemplate = html.querySelector(`.${this._rootElementName}-report`);
        this._closeButton = html.querySelector(`${class_prefix}-close`);
        this._closeButton.onclick = this.hide.bind(this);
        this._contentNode = this._element.querySelector(`${class_prefix}-content`);
    }
    /**
     * Sets the article content in the overlay
     */
    article(headline) {
        let template = this._articleTemplate.cloneNode(true);
        ...
        let tags = template.querySelector(`.${this._rootElementName}-overlay-tags`);
        ...
        this.showTextOrHideLine(template, 'words', Object(__WEBPACK_IMPORTED_MODULE_4__util_util__["wordsToReadingTimeInMinutes"])(this._info.revision.words));
     ...
     */
    showTextOrHideLine(template, selector, data, isHtml = false) {
        let node = template.querySelector(`.${this._rootElementName}-${selector}`);
        if (data.length == 0) {
     ...
     */
    external(headline) {
        let template = this._externalTemplate.cloneNode(true);
        // Display location and link and header as name of the site
        let summary = headline.summary !== null ? headline.summary.one_line : "";
        this.showTextOrHideLine(template, 'summary', summary);
        this.showTextOrHideLine(template, 'source', Object(__WEBPACK_IMPORTED_MODULE_4__util_util__["trimUrlGetParams"])(headline.url));
        this.setContent(template, `External site ${Object(__WEBPACK_IMPORTED_MODULE_4__util_util__["trimUrlToHostname"])(headline.url)}`);
    }
    /**
     * Sets the feed content in the overlay
     */
    feed(headline) {
        let template = this._feedTemplate.cloneNode(true);
        let summary = headline.summary !== null ? headline.summary.one_line : "";
        this.showTextOrHideLine(template, 'summary', summary);
    ...
    video(headline) {
        ...
        let template = this._videoTemplate.cloneNode(true);
        let summary = headline.summary !== null ? headline.summary.one_line : "";
        this.showTextOrHideLine(template, 'summary', summary);
     ...
     */
    noInfo(headline) {
        let template = this._noInfoTemplate.cloneNode(true);
        let summary = headline.summary !== null ? headline.summary.one_line : "";
        this.showTextOrHideLine(template, 'summary', summary);
     ...
     * @param headline
     */
    updateContent(headline) {
        super.updateContent(headline);
        switch (headline.info.category) {
            case __WEBPACK_IMPORTED_MODULE_2__models_article__["ArticleCategory"].Article:
                this.article(headline);
                break;
            case __WEBPACK_IMPORTED_MODULE_2__models_article__["ArticleCategory"].External:
                this.external(headline);
                break;
            case __WEBPACK_IMPORTED_MODULE_2__models_article__["ArticleCategory"].Video:
                this.video(headline);
                break;
            case __WEBPACK_IMPORTED_MODULE_2__models_article__["ArticleCategory"].Feed:
                this.feed(headline);
                break;
            default:
            case __WEBPACK_IMPORTED_MODULE_2__models_article__["ArticleCategory"].NoInfo:
...
/* harmony default export */ __webpack_exports__["default"] = (HeadlineOverlay);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__config_messageTypes__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__headline_front_page_injector__ = __webpack_require__(47);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__util_debug__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__headline_link_injector__ = __webpack_require__(48);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__util_util__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__article_injector__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__contextMenuListener__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__headline_overlay__ = __webpack_require__(49);
...
let modal = __WEBPACK_IMPORTED_MODULE_0__modal__["default"].getInstance();
let headlineInfoOverlay = new __WEBPACK_IMPORTED_MODULE_8__headline_overlay__["default"]();
let frontPageInjector = new __WEBPACK_IMPORTED_MODULE_2__headline_front_page_injector__["default"](headlineInfoOverlay);
let linkInjector = new __WEBPACK_IMPORTED_MODULE_4__headline_link_injector__["default"](headlineInfoOverlay);
let articleInjector = new __WEBPACK_IMPORTED_MODULE_6__article_injector__["default"](headlineInfoOverlay);
let passDataToArticleInjector = (data, callback) => {
    for (let storageItem of data.sites) {
        ...
        if (location.hostname.indexOf(site.base_url) > -1) {
            ...
            let articleMessage = Object(__WEBPACK_IMPORTED_MODULE_1__config_messageTypes__["createMessage"])(__WEBPACK_IMPORTED_MODULE_1__config_messageTypes__["messageTypes"].FETCH_ARTICLE, messageData);
...
let passDataToInjectors = (frontPageInjectorCallback, linkInjectorCallback, articleInjectorCallback) => {
    ...
    let initData = Object(__WEBPACK_IMPORTED_MODULE_1__config_messageTypes__["createMessage"])(__WEBPACK_IMPORTED_MODULE_1__config_messageTypes__["messageTypes"].IS_SITE_SUPPORTED, url);
    chrome.runtime.sendMessage(initData, (data) => {
        if (data.sites == 0)
            return;
        let isFrontPage = data.sites.length === 1 && Object(__WEBPACK_IMPORTED_MODULE_5__util_util__["trimUrlGetParams"])(Object(__WEBPACK_IMPORTED_MODULE_5__util_util__["trimUrlToPath"])(url)).length === 0;
        let isArticle = data.sites.length === 1 && Object(__WEBPACK_IMPORTED_MODULE_5__util_util__["trimUrlGetParams"])(Object(__WEBPACK_IMPORTED_MODULE_5__util_util__["trimUrlToPath"])(url)).length > 0;
        if (isFrontPage)
...
chrome.runtime.onMessage.addListener(function (request, sender, sendResponse) {
    __WEBPACK_IMPORTED_MODULE_3__util_debug__["default"].info("Message to contentscript", request);
    switch (request.type) {
        case __WEBPACK_IMPORTED_MODULE_1__config_messageTypes__["messageTypes"].SITES_UPDATED:
            passDataToInjectors(frontPageInjector.update, linkInjector.update, articleInjector.update);
            break;
        case __WEBPACK_IMPORTED_MODULE_1__config_messageTypes__["messageTypes"].SHOW_IN_MODAL:
...
window.addEventListener('contextmenu', (e) => {
    let action = (id) => chrome.runtime.sendMessage(Object(__WEBPACK_IMPORTED_MODULE_1__config_messageTypes__["createMessage"])(__WEBPACK_IMPORTED_MODULE_1__config_messageTypes__["messageTypes"].TOGGLE_CONTEXT_MENU, id));
    let finder = new __WEBPACK_IMPORTED_MODULE_7__contextMenuListener__["default"](action);
    if (!finder.findAttr(e.target, 0, 10, "down"))
        finder.findAttr(e.target, 0, 10, "up");
}, false);
